...
public enum AppThemePreset {
    ...
    MIDNIGHT(UiText.ThemePresets.MIDNIGHT_LABEL, UiText.ThemePresets.MIDNIGHT_DESCRIPTION,
            new AppTheme(UiText.ThemePresets.MIDNIGHT_LABEL, "#10151D", "#18202B", "#5B86D6", "#A6B2C6", "#0A0F15", "#202938")),
